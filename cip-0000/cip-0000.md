...
Following a discussion, the proposal should be submitted to the [cips git repository](https://github.com/global-synchronizer-foundation/cips) as a pull request.
